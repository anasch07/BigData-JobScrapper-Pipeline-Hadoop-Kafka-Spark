...
export  const   websiteAudienceChartOptions = {
    scales: {
        yAxes: [{
            display: true,
            gridLines: {
...
export const   bounceRateChartOptions = {
    scales: {
        yAxes: [{
            display: false,
            gridLines: {
...
export const data =
    [
        {
            industry: 'Engineering and Information Technology',
            count: 8411
        },
